                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="datatablesSimple">
                                        ...
                                        <tbody>
                                            <?php
                                            $ambilsemuadatapelanggan = mysqli_query($conn, "SELECT * FROM konfirmasi ");
                                            $i = 1;

                                            while ($data = mysqli_fetch_array($ambilsemuadatapelanggan)) {
                                                $idkonfirmasi = $data['ID_Konfirmasi'];                                          
                                                $idbooking= $data['ID_Booking'];
                                                $harga= $data['Harga'];
                                                $fototransfer= $data['Foto_Transfer'];
                                            ?>
                                            <tr>
                                                <td><?= $idkonfirmasi ?></td>                                              
                                                <td><?= $idbooking; ?></td>
                                                <td><?= $harga; ?></td>
                                                <td><img src="<?= $fototransfer; ?>" style="width: 100px; height: auto;" alt="foto"></td>                                                
                                            </tr>
                                                    </div>
                                                </div>
                                            </div>
